...
public interface UserDao extends AbstractDao<User> {
     ...
     *
     * @param property The type of property to look for
     * @param value    Value of the property to look for
     *
     ...
     *
     * @param userId ID of the user whose status to change
     ...
     *
     * @param cardNumber Number of the card to add money to
